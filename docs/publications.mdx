...
- [Thanh Nguyen and H.L. Thi (2023)](./projects.mdx#Applications-of-Quantum-Algorithms-in-Finance): "Variational Quantum Algorithms in Finance." Accepted for *Lecture Notes in Networks and Systems - Springer*.

- [Thanh Nguyen and H.L. Thi (2023)](./projects.mdx#Applications-of-Quantum-Algorithms-in-Finance): "Variational Quantum Algorithms in Anomaly Detection, Fraud Indicator Identification, Credit Scoring, and Stock Price Prediction".  Accepted for *Lecture Notes in Networks and Systems - Springer*.
